...
<head>
    <title>Teamcot Bangladesh Ltd</title>
    <meta name="description" content="Teamcot Bangladesh Ltd">
    <meta name="keywords"
          content="Teamcot Bangladesh Ltd is a cotton agency in Bangladesh having more than 20 years working experience in this trade. We mainly deal with raw cotton. Our motto is to work with only ethical buyers and sellers with the view of establishing safe trading.">
    <meta charset="utf-8">
...
<!-- navigation -->
<nav
    class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav nav-white nav-dark no-transition"
    role="navigation">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-9 text-center center-col">
                ...
                <div class="col-md-4 col-sm-4 text-center"><i class="icon-map-pin medium-icon black-text"></i>
                    <h6 class="black-text margin-two no-margin-bottom">8/C, Al-Haj Shamsuddin Mansion, 17 New Eskaton
                        Road, Dhaka-1000</h6>
                </div>
        ...
        <div class="container">
            <div class="row margin-three">
                ...
                <div
                    ...
                    &copy; 2021 Teamcot Bangladesh. All Rights Reserved.
                </div>
                <!-- end copyright -->
                <!-- logo -->
                <div class="col-md-6 col-sm-6 col-xs-12 footer-logo text-right copyright xs-text-center"> Developed By:
                    <a href="https://innovabd.tech/" style="color: white;">Innova Tech Bangladesh</a>
                </div>
                <!-- end logo -->
            </div>
        </div>
